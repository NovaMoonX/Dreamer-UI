...
const searchIndex: SearchResult[] = [
	...
	// AuthForm Component
	{
		...
		description: 'Flexible authentication form component supporting multiple providers and modes.',
		type: 'Component',
		content: 'authform authentication login signup signin register form email password oauth google github facebook apple providers methods action toggle props',
		rank: 10,
	},
	{
		title: 'AuthForm Props',
		path: '/components/authform',
		section: 'Props',
	...
	{
		title: 'AuthForm Methods Example',
		path: '/components/authform',
		section: 'Authentication Methods',
		description: 'Configure authentication methods including email/password and OAuth providers.',
		type: 'Example',
		content: 'authform methods email password oauth providers google github facebook apple authentication login signup example',
		rank: 7,
	},
	{
		title: 'AuthForm Action Modes Example',
		path: '/components/authform',
		section: 'Action Modes',
		description: 'Different action modes: login only, signup only, or toggleable between both.',
		type: 'Example',
		content: 'authform action modes login signup both toggle switch authentication form example',
		rank: 7,
	},
	{
		title: 'AuthForm Password Validation Example',
		path: '/components/authform',
		section: 'Password Validation',
		description: 'Custom password validation with real-time feedback during signup.',
		type: 'Example',
		content: 'authform password validation custom validatePassword function signup registration security requirements example',
		rank: 7,
	},
	{
		title: 'AuthForm Error Handling Example',
		path: '/components/authform',
